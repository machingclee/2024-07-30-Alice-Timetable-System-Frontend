...
export default ({
    ...
    const createClassPopperFromHourTimestampOnShow = useAppSelector((s) => s.app.createClassPopperFromHourTimestampOnShow);
    ...
    return (
        <div>
            ...
            {openDialog && timetableAction === "Create Class" && (
                ...
                >
                    <AddClassEventPopover openDialog={openDialog} setOpenDialog={setOpenDialog} setVisible={setVisible} dayUnixTimestamp={0} hourUnixTimestamp={0} studentId={""} />
                </Popper>
            )}
        </div>
    );
