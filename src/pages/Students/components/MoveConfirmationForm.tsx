...
export default (props: {
    moveClassesAction: () => Promise<void>
}) => {
    ...
    return (
        <Box
            ...
            <SectionTitle>
                Are you sure to move the classes?
            </SectionTitle>
            <div>
                <Spacer />
            </div>
            <Alert severity="warning">
                <div>This timeslot is <b>within a group of duplicated classes</b>, do you want to move all of them?</div>
                <Spacer />
