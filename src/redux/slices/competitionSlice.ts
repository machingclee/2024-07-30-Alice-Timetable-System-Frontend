...
const competitionSlice = createSlice({
    ...
    reducers: {
        ...
        addOption: (state, action: PayloadAction<{ competitionId: string; questionId: string; optionId: string; optionText: string }>) => {
            const { competitionId, questionId, optionId, optionText } = action.payload;
            const competition = state.competitions.idToObject?.[competitionId];
            if (competition) {
                ...
                switch (question.type) {
                    case "MultipleChoiceQuestion":
                        ...
                        question.optionIdToOption[newMultipleChoiceOption.id] = newMultipleChoiceOption;
                        return;
                    case "SingleChoiceQuestion":
                        ...
                        // Push a new object to [id]
                        question.optionIdToOption[newSingleChoiceOption.id] = newSingleChoiceOption;
                        return;
                }
            }
        },
        ...
        changeQuestionCompulsoryStatusToTheOpposite: (state, action: PayloadAction<{ competitionId: string; questionId: string }>) => {
        ...
        deleteOption: (state, action: PayloadAction<{ competitionId: string; questionId: string; optionId: string }>) => {
            ...
            if (competition && question) {
                switch (question.type) {
                    case "MultipleChoiceQuestion":
                        ...
                        question.optionIds = question.optionIds.filter((id) => id !== optionId);
